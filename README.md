...
- Error tracking - Removed (was Sentry)
...
| Global Error           | A centralized error page that captures and displays errors across the application. Basic error logging to console (Sentry integration removed). |
